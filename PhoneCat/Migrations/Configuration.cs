namespace PhoneCat.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PhoneCatContext>
    {
        ...
        protected override void Seed(PhoneCatContext context)
        {
            ...
            AddOrUpdatePhoneAndroid(context, "LG-Axis", "Android 2.1", "LG");
            AddOrUpdatePhoneAndroid(context, "Nexus S", "Android 2.3","Nex");
            AddOrUpdatePhoneAndroid(context, "Samsung Galaxy Tab\u2122", "Android 2.1","Sams");
        ...
        void AddOrUpdatePhoneAndroid(PhoneCatContext context, string phoneName, string version, string ui)
        {
            ...
            var userI = os.Androids.FirstOrDefault(u => u.Ui == ui);
            if (userI == null)
                phn.Android = new Android { Os = os, Ui = ui };
            else phn.Android = userI;
        }
    }
}
